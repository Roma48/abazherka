...
if (!defined('_GK_MENU_CLASS')) {
    ...
    class GKMenu extends GKMenuBase {
        ...
        function beginMenu($startlevel = 0, $endlevel = 10) {
            ...
            echo "<nav class=\"gkMainMenu gkMenu\" data-duration=\"".$params->get('menu_duration', '500')."\" data-opacity=\"".$params->get('menu_opacity', '1')."\" data-height=\"".$params->get('menu_height', '1')."\" data-width=\"".$params->get('menu_width', '0')."\">\n";
        }
        ...
        function beginMenuItems1($pid = 0, $level = 0, $return = false) {
            ...
            $data = "<div class=\"".$type_class." has-cols-".($this->items[$pid]->gkparams->get('cols'))."\">\n<div class=\"".$type_class."-inner\">\n";
            if ($return) return $data; else echo $data;
        }
