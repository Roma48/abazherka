...
$override .=  'com_tags' . DS . 'tag' . DS . 'default_items.php';
		...
		<?php foreach ($items as $i => $item) : ?>
			...
			<?php else: ?>
				<li class="cat-list-row<?php echo $i % 2; ?> clearfix" >
					<h2>
						<a href="<?php echo JRoute::_(TagsHelperRoute::getItemRoute($item->content_item_id, $item->core_alias, $item->core_catid, $item->core_language, $item->type_alias, $item->router)); ?>" class="inverse">
