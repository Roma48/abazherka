...
<article class="item-view">
	<h2 class="item-title">
		<a href="<?php echo JRoute::_($route); ?>" class="inverse">
			<?php echo $this->result->title; ?>
		</a>
	</h2>
	
	<?php if($show_description) : ?>
	<div class="item-body <?php echo $this->pageclass_sfx; ?>">
		<?php echo JHtml::_('string.truncate', strip_tags($this->result->description), $this->params->get('description_length', 255)); ?>
	</div>
	<?php endif; ?>
