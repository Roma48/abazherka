...
<form id="com-form-login" action="<?php echo JRoute::_('index.php'); ?>" method="post" name="com-login" >
     ...
     <div class="formLoginWrap">
          ...
          <?php endif; ?>
          <div class="clr"></div>
          <a   href="<?php echo JRoute::_('index.php?option='.$comUserOption.'&view=reset'); ?>" rel="nofollow"> <?php echo JText::_('COM_VIRTUEMART_ORDER_FORGOT_YOUR_PASSWORD'); ?></a> <a   href="<?php echo JRoute::_('index.php?option='.$comUserOption.'&view=remind'); ?>" rel="nofollow"> <?php echo JText::_('COM_VIRTUEMART_ORDER_FORGOT_YOUR_USERNAME'); ?></a> 
