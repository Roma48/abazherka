...
$override .=  'com_newsfeeds' . DS . 'newsfeed' . DS . 'default.php';
...
<div class="newsfeed<?php echo $this->pageclass_sfx?><?php echo $direction; ?>">
	<header class="component-header">
		...
		<?php endif; ?>
		<h2> <a href="<?php echo $this->newsfeed->channel['link']; ?>" target="_blank"> <?php echo str_replace('&apos;', "'", $this->newsfeed->channel['title']); ?></a> </h2>
