...
$override .=  'com_content' . DS . 'category' . DS . 'blog.php';
...
<div id="comContentContainer" class="blog-page <?php echo $this->pageclass_sfx;?>" itemscope itemtype="http://schema.org/Blog">
	<?php if (
		...
		(
			...
			($this->params->get('show_description_image') && $this->category->getParams()->get('image') != '') ||
			$templateParams->get('display_mouse_icon', '1') != '0'
		)
	) : ?>
	<div class="header<?php if(!($this->params->get('show_description_image') && $this->category->getParams()->get('image'))): ?> no-image<?php endif; ?>">
		<?php if($this->params->get('show_description_image') && $this->category->getParams()->get('image') != ''): ?>
		<img alt="<?php echo htmlspecialchars($this->category->name); ?>" src="<?php echo $this->category->getParams()->get('image'); ?>" />
		<?php endif; ?>
		
		<?php if($this->params->get('show_category_title', 1)): ?>
		<div class="item-title-wrap">
			<h1 class="item-title" data-sr="enter bottom and move 50px"><?php echo $this->category->title; ?></h1>
