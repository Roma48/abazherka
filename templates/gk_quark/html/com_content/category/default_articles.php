...
$override .=  'com_content' . DS . 'category' . DS . 'default_articles.php';
...
<?php if (empty($this->items)) : ?>
	...
	<?php endif; ?>
<?php else : ?>
	<form action="<?php echo htmlspecialchars(JFactory::getURI()->toString()); ?>" method="post" name="adminForm" id="adminForm" class="gk-page">
		...
		<table>
			...
			<thead>
				<tr>
					<th <?php echo $headerTitle; ?> class="list-title" id="tableOrdering">
						<?php  echo JHtml::_('grid.sort', 'JGLOBAL_TITLE', 'a.title', $listDirn, $listOrder) ; ?>
					</th>
	
					<?php if ($date = $this->params->get('list_show_date')) : ?>
					<th <?php echo $headerDate; ?> class="list-date" id="tableOrdering2">
						<?php if ($date == "created") : ?>
					...
					<th <?php echo $headerAuthor; ?> class="list-author" id="tableOrdering3">
						<?php echo JHtml::_('grid.sort', 'JAUTHOR', 'author', $listDirn, $listOrder); ?>
					</th>
					<?php endif; ?>
	
					<?php if ($this->params->get('list_show_hits', 1)) : ?>
					<th <?php echo $headerHits; ?> class="list-hits" id="tableOrdering4">
