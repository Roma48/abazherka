	...
	<table class="adminlist table table-striped table-hover" cellpadding="1">
		<thead>
			<tr>
				...
				<th class="title titletoggle">
					<?php echo JHTML::_('grid.sort', JText::_( 'ACY_CLICK_EFFICIENCY' ), 'a.clickefficiency', $this->pageInfo->filter->order->dir, $this->pageInfo->filter->order->value,'listing' ); ?>
				</th>
				<?php } ?>
				<th class="title titletoggle">
				...
				<?php } ?>
				<th class="title titletoggle">
					<?php echo JHTML::_('grid.sort',   JText::_( 'ACY_SENT' ), 'a.senthtml', $this->pageInfo->filter->order->dir, $this->pageInfo->filter->order->value,'listing' ); ?>
				</th>
